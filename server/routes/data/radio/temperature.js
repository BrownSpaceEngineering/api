...
router.get('/', function (req, res, next) {
  Temperature.findAllTemperatures()
...
router.post('/:error', function (req, res , next ) {
  ...
  Temperature.addTemperature(req.params['temp'])
...
router.get('/:id', function (req, res, next) {
  Temperature.getTemperatureByID(req.params['id'])
...
router.delete('/:id', function(req, res, next) {
  Temperature.deleteTemperature(req.params['id'])
  .then(function() {
    res.status(200).end()
  })
})
...
router.put('/:id/:error', function (req, res, next) {
  Temperature.updateTemperature(req.params['id'], req.params['temp'])
